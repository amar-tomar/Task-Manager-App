      ...
      <div className='space-y-4 mt-4'>
        ...
        {attachments.map((item, index) => (
          ...
          >
            ...
            >
              <HiOutlineTrash className='text-red-500 text-l' />
            </button>
          </div>
        ))}
        ...
        <div className='md:flex lg:flex items-center gap-2 '>
          ...
          <button
            ...
            className='flex items-center gap-1 lg:mt-0 mt-4 px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors'
